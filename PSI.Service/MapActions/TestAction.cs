...
{
    public class TestAction : IMappingAction<DTO_SalesWeightNote, SalesWeightNote>
    {
        ...
        public void Process(DTO_SalesWeightNote source, SalesWeightNote destination, ResolutionContext context)
        {
