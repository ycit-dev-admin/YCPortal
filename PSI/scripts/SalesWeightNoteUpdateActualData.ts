class SalesWeightNoteUpdateActualData {
    ...
    /* Field Doms */
    // this
    public DomOfActualInvoiceprice = document.getElementById('ActualInvoiceprice') as HTMLSpanElement;
    public DomOfActualLeaveWeight = document.getElementById('ActualLeaveWeight') as HTMLInputElement;
    public DomOfActualDefectiveWeight = document.getElementById('ActualDefectiveWeight') as HTMLInputElement;
    public DomOfActualUnitPrice = document.getElementById('ActualUnitPrice') as HTMLInputElement;
    public DomOfActualInvoicePriceHasTax = document.getElementById('ActualInvoicePriceHasTax') as HTMLInputElement;
    public DomOfActualTraficUnitPrice = document.getElementById('ActualTraficUnitPrice') as HTMLInputElement;
    public DomOfActualTraficHasTax = document.getElementById('ActualTraficHasTax') as HTMLInputElement;
    public DomOfActualTraficprice = document.getElementById('ActualTraficprice') as HTMLSpanElement;
    public DomOfActualInvoiceTax = document.getElementById('ActualInvoiceTax') as HTMLSpanElement;
    public DomOfActualTraficTax = document.getElementById('ActualTraficTax') as HTMLSpanElement;
    public DomOfActualReceivedprice = document.getElementById('ActualReceivedprice') as HTMLSpanElement;
    ...
    private CaculateAllFee() {
        ...
        let funcRs = this.SalesPriceAPI.GetInvoicePrice(
            +this.DomOfActualLeaveWeight.value,
            +this.DomOfActualDefectiveWeight.value,
            +this.DomOfActualUnitPrice.value,
            this.DomOfActualInvoicePriceHasTax.checked
        );
        let funcRs2 = this.SalesPriceAPI.GetDeliveryPrice(
            +this.DomOfActualLeaveWeight.value,
            +this.DomOfActualTraficUnitPrice.value,
            this.DomOfActualTraficHasTax.checked
        );
        ...
        $.when(funcRs, funcRs2).then(function (data, data2) {
            ...
            {
                let funcRs3 = thisObj.SalesPriceAPI.GetTaxPrice(+data[0]);
            ...
            {
                let funcRs4 = thisObj.SalesPriceAPI.GetTaxPrice(+data2[0]);
                $.when(funcRs4).then(function (data: number) {
            ...
            let funcRs9 = thisObj.SalesPriceAPI.GetReceivedPrice(
                data[0],
                data2[0]
            );

            $.when(funcRs9).then(function (data: number) {
