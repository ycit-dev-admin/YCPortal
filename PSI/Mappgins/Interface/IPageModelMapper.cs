...
namespace PSI.Mappgins.Interface
{
    public interface IPageModelMapper  // IEntityMapper  IPageModelMapper IPEModelMapper
    {
        ...
        IMapper GetMapper<T1, T2>(SalesWeightNote salesWeightNote = null)
           where T1 : SalesWeightNote
           where T2 : WeightNoteUpdateActualData;

        IMapper GetMapper<T1>(SalesWeightNote salesWeightNote = null, WeightNoteUpdateActualData weightNoteUpdateActualData = null)
          where T1 : SalesWeightNote;
